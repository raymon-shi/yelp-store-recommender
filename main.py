...
def main():
    ...
    # options: 'shortest path between all', 'longest chain of satisfactory coffee shops', 'menu please',
    # 'photos please', 'best plan overall greatest happiness - game theory'
    ...
    if choice == 'shortest path between all':
        ...
        # enter name of store you want pictures from
        picture_request = input('what is the name of the store you want pictures from?: ')

        request_pictures(picture_request, yelp_top_ten_list)

    elif choice == 'best plan overall greatest happiness - game theory':
        # first get player A's choice
        player_A_list = player_A_search()

        # second get player B's choice
        player_B_list = player_B_search()

        # find the best overall strategy that maximizes happiness aka utility
        the_game_theory(player_A_list, player_B_list)
